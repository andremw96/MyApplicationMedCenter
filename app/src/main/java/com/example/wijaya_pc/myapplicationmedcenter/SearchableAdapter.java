...
public class SearchableAdapter extends BaseAdapter implements Filterable {
    ...
    public SearchableAdapter(TransactionListActivity transactionListActivity, int simple_list_item_1, ArrayList<Penyakit> transList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // by ListView is null.
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.activity_transaction_list, null);

            // Creates a ViewHolder and store references to the two children views
            // we want to bind data to.
            holder = new ViewHolder();
            holder.text = (TextView) convertView.findViewById(R.id.idDaftar);
